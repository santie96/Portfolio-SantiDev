...
function ProjectCard({ slug, title, img, description, tags = [], demo = "#", repo = "" }) {
  ...
  return (
    ...
    >
      <div className="w-full bg-[radial-gradient(circle_at_top,rgba(96,165,250,0.25),transparent_55%)] p-5">
        <img 
        src={img} 
        alt={title} 
